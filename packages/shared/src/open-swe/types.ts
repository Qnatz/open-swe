...
export const GraphConfigurationMetadata: {
  ...
  plannerModelName: {
    x_open_swe_ui_config: {
      type: "select",
      default: "google-genai:gemini-1.5-flash-latest",
      description:
...
export const GraphConfiguration = z.object({
  /**
   * The model to use for the entire run. This is an optional
   * value that will override any other model configuration.
   *
   * @example "local"
   */
  model: withLangGraph(z.string().optional(), {
    metadata: GraphConfigurationMetadata.model,
  }),
  /**
